        ...
        <div className="app-container">
            ...
            <div className="main-container">
                <div className="tab-container">
                    <button
                        className={`tab-button ${activeTab === 'workouts' ? 'active-tab' : ''}`}
                        onClick={() => setActiveTab('workouts')}
                    >
                        <span className="tab-icon">💪</span> Workouts
                    </button>
                    <button
                        className={`tab-button ${activeTab === 'stats' ? 'active-tab' : ''}`}
                        onClick={() => setActiveTab('stats')}
                    >
                        <span className="tab-icon">📊</span> Stats
                    </button>
                    <button
                        className={`tab-button ${activeTab === 'goals' ? 'active-tab' : ''}`}
                    ...
                    <div className="tab-content">
                        ...
                        {workout.type.charAt(0).toUpperCase() + workout.type.slice(1)}
                                        ...
                                        <div className="workout-actions">
                                            <button
                                                className={`action-button ${workout.completed ? 'complete-button' : 'mark-button'}`}
                    ...
                    <div className="tab-content">
                            ...
                            <div className="stats-card">
                                <div className="stats-header">
                                    <label className="stats-label">
                                        <span className="stats-icon">👣</span> Steps Today
                                    </label>
                                    {goals.steps > 0 && (
                      ...
                      Goal: {goals.steps.toLocaleString()}
                            ...
                            <div className="stats-card">
                                <div className="stats-header">
                                    <label className="stats-label">
                                        <span className="stats-icon">🔥</span> Calories Consumed
                                    </label>
                                    {goals.calories > 0 && (
                                        <span className="goal-label">
                      Goal: {goals.calories.toLocaleString()}
                        ...
                        <div className="stats-card summary-card">
                            <h3 className="section-title">
                                <span className="stats-icon">🏆</span> Today's Progress
                            </h3>
                        ...
                        <div className="goals-container">
                            ...
                            {currentWeight > 0 && goals.weight > 0 && (
                                <div className="goals-card">
                                    ...
                                    <div className="progress-bar-container">
                                        <div
                                            className={`progress-bar ${currentWeight > goals.weight ? 'weight-loss-progress' : 'weight-gain-progress'}`}
